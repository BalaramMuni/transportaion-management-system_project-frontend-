              ...
              <li key={to}>
                ...
                >
                  {({ isActive }) => (
                    <>
                      <span
                        className={`z-10 flex h-6 w-6 items-center justify-center rounded-full border-2 bg-surface ${isActive ? 'border-route-500 text-route-500' : 'border-ink-100 text-ink-300'
                          }`}
                      >
                        <Icon size={13} />
                      </span>
